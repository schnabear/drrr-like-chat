...
return array(
	...
	"Cannot create new room any more." => "Error: Too many rooms.",
	"{1} logged in." => "-- {1} logged in.",
	"{1} logged out." => "-- {1} logged out.",
	"{1} lost the connection." => "-- {1} was disconnected.",
	"Data Error: Room creating failed." => "Error: Failed to create a room.",
	"Room Name" => "Room name",
	"Max Members" => "User capacity",
	"{1} members" => "{1} users",
	"Up to {1} rooms can be created." => "*You can create {1} rooms at maximum.",
	...
	"{1} is a new host." => "-- {1} is the new host.",
	"Change" => "Change",
	...
	"Handover host" => "Handover host",
	"Ban user" => "Ban user",
	"Host is invaild." => "Host is invaild.",
	"User not found." => "User not found.",
	"Gave host rights to {1}." => "Gave host to {1}.",
